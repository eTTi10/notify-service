...
class PushAnnounceClientImplTest {
    ...
    void testServerException() {
        ...
        assertThrows(InternalErrorException.class, () -> {
            throw pushErrorDecoder.decode("", response500);
        });
        final Response response502 = getHttpResponse(502);
        assertThrows(ExceptionOccursException.class, () -> {
            throw pushErrorDecoder.decode("", response502);
        });
        final Response response503 = getHttpResponse(503);
        assertThrows(ServiceUnavailableException.class, () -> {
            throw pushErrorDecoder.decode("", response503);
        });
        final Response response504 = getHttpResponse(504);
        assertThrows(PushEtcException.class, () -> {
            throw pushErrorDecoder.decode("", response504);
        });
    }
    ...
    void testClientException() {
        ...
        assertThrows(BadRequestException.class, () -> {
            throw pushErrorDecoder.decode("", response400);
        });
        final Response response401 = getHttpResponse(401);
        assertThrows(UnAuthorizedException.class, () -> {
            throw pushErrorDecoder.decode("", response401);
        });
        final Response response403 = getHttpResponse(403);
        assertThrows(ForbiddenException.class, () -> {
            throw pushErrorDecoder.decode("", response403);
        });
        final Response response404 = getHttpResponse(404);
        assertThrows(NotFoundException.class, () -> {
            throw pushErrorDecoder.decode("", response404);
        });
        final Response response410 = getHttpResponse(410);
        assertThrows(NotExistRegistIdException.class, () -> {
            throw pushErrorDecoder.decode("", response410);
        });
        final Response response412 = getHttpResponse(412);
        assertThrows(PreConditionFailedException.class, () -> {
            throw pushErrorDecoder.decode("", response412);
        });
        final Response response422 = getHttpResponse(422);
        assertThrows(PushEtcException.class, () -> {
            throw pushErrorDecoder.decode("", response422);
        });
    }
    ...
    void testFeignException() {
        ...
        assertThrows(AcceptedException.class, () -> {
            throw pushErrorDecoder.decode("", response202);
        });
        final Response response205 = getHttpResponse(205);
        assertThrows(PushEtcException.class, () -> {
            throw pushErrorDecoder.decode("", response205);
        });
    }
