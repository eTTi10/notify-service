...
@Sharable
    @Slf4j
    public class NettyClientSample extends TransportBase { //} extends TransportBase implements Transport, TransportChannel, InitClose, StartStop, AlarmAware,
        ...
        public NettyClientSample() {
        }
/*
        public NettyClientSample(TransportCallback callback, RpcCodec codec, ServiceMetas serviceMetas) {
        ...
        public void init() {
            ...
            bootstrap.group(workerGroup).channel(NioSocketChannel.class).handler(new ChannelInitializer<SocketChannel>() {
                ...
                protected void initChannel(SocketChannel ch) throws Exception {
                    ...
                    pipeline.addLast("handler", NettyClientSample.this);
                }
            });
        ...
        void reconnect(final String connId, final String addr) {
            ...
            future.addListener(new ChannelFutureListener() {
                public void operationComplete(ChannelFuture future) {
                    NettyClientSample.this.onConnectCompleted(future, connId, addr);
                }
            });
        }
