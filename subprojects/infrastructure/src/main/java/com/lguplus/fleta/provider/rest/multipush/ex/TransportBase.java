...
public abstract class TransportBase extends ChannelDuplexHandler{
    ...
    public boolean send(String connId, Object data) { //RpcData data) {
...
/*
    ...
    */
    ...
    public interface TransportCallback {
        ...
        boolean isExchange(String connId, Object meta);

        void receive(String connId, Object data, long receiveMicros);
