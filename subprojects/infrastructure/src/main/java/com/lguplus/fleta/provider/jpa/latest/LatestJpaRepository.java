...
public class LatestJpaRepository implements LatestRepository {
    ...
    @Override
    public List<LatestDto> getLatest(LatestRequestDto latestRequestDto) {
        log.debug("==================== LatestJpaRepository.getLatest ====================BEGIN");
        ...
        Query nativeQuery = entityManager.createNativeQuery(sql, LatestDto.class);
        ...
        log.debug("==================== LatestJpaRepository.getLatest ====================END");
