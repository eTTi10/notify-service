...
import com.lguplus.fleta.provider.soap.mmsagent.module.content.*;
import com.lguplus.fleta.provider.soap.mmsagent.module.inf.Content;
import com.lguplus.fleta.provider.soap.mmsagent.module.inf.HasContent;
import com.lguplus.fleta.provider.soap.mmsagent.module.inf.JDOMSupport;
...
public class MM7Message implements JDOMSupport {
	...
	public String getSoapBoundary() {
		if (soapBoundary == null) {
			this.soapBoundary = "NextPart_" + UUID.randomUUID().toString();
		}
		return soapBoundary;
	}
