...
public class SendMmsVo {
    ...
    @ParamAlias("ctn")
    @NotBlank(message = "필수 요청 정보 누락(ctn 가 Null 혹은 빈값 입니다.)", groups = Groups.C3.class,payload = MmsParameterMissingException.class)
    ...
    @ParamAlias("mms_cd")
    @NotBlank(message = "필수 요청 정보 누락(mms_cd 가 Null 혹은 빈값 입니다.)", groups = Groups.C4.class,payload = MmsParameterMissingException.class)
