...
public class MusicShowController {
    ...
    @ApiImplicitParams(value = {
        @ApiImplicitParam(paramType = "query", dataType = "string", required = true, name = "sa_id", value = "순번: 1<br>자리수: 12<br>설명:가입번호", example = "500004587606"),
        @ApiImplicitParam(paramType = "query", dataType = "string", required = true, name = "stb_mac", value = "순번: 2<br>자리수: 20<br>설명: 가입자 STB MAC Address", example = "v000.0458.7606"),
        @ApiImplicitParam(paramType = "query", dataType = "string", required = true, name = "album_id", value = "순번: 3<br>자리수: 15<br>설명: 앨범ID", example = "M0118C3162PPV00")
    })
    @GetMapping
    public GetPushResponseDto getPush(@Valid PushRequestVo requestVo) {
        PushRequestDto requestDto = requestVo.makeRefinedGetRequest();

        return service.getPush(requestDto);
    }
    ...
    @ApiImplicitParams(value = {
        ...
        @ApiImplicitParam(paramType = "query", dataType = "string", required = true, name = "category_id", value = "순번: 3<br>자리수: 5<br>설명: 카테고리ID", example = ""),
        @ApiImplicitParam(paramType = "query", dataType = "string", required = true, name = "album_id", value = "순번: 4<br>자리수: 15<br>설명: 앨범ID", example = ""),
        @ApiImplicitParam(paramType = "query", dataType = "string", required = true, name = "album_nm", value = "순번: 5<br>자리수: <br>설명: 앨범명", example = ""),
        @ApiImplicitParam(paramType = "query", dataType = "string", required = true, name = "start_dt", value = "순번: 6<br >자리수: 12<br>설명: 공연시작일시", example = "201912012359")
    })
    @PostMapping
    public PostPushResponseDto registerPush(@Valid PostPushRequestVo requestVo) {
        ...
        return service.postPush(requestDto);
    }
    ...
    public PostPushResponseDto releasePush(@Valid PushRequestVo requestVo) {
        ...
        return service.releasePush(requestDto);
    }
}
